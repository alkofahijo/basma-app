...
class RegisterChoicePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Do not wrap the entire page with Obx. Use granular Obx widgets where needed
    // to avoid improper GetX usage (GetX should target only the widgets that update).
